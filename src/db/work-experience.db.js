...
const workExperience = [
  {
    ...
    Company: `Pixel Softwares`,
    Location: 'Panchkula, HARYANA, INDIA',
    Type: 'Job',
    Duration: 'Mar 2023 - Present',
    points: [
      'Proficient in MERN (MongoDB, Express.js, React.js, Node.js) stack for dynamic web app creation.',
      'Utilized blockchain integration for enhanced security and user trust.',
      'Implemented Pinata for decentralized file storage and data resilience.',
      'Tech Stack: MERN Stack, ether.js, wagmi, wallectconnect, etc.',
    ],
