...
import savekaro1 from './savekaro/savekaro1.jpeg';
...
import savekaro5 from './savekaro/5.png';
import savekaro6 from './savekaro/6.png';
...
export const portfolioImages = [
  // { name: 'Frontend', imageType: projectType.WEB, url: portfolio1 },
  // { name: 'Frontend', imageType: projectType.WEB, url: portfolio2 },
  // { name: 'Frontend', imageType: projectType.WEB, url: portfolio3 },
  // { name: 'Frontend', imageType: projectType.WEB, url: portfolio4 },
];

export const saveKaroImages = [
